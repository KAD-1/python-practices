...
class TestTopStudentsAnalyser(unittest.TestCase):
    ...
    def test_analyse_twice(self):
        ...
        analyser.analyse()
        self.assertEqual(analyser.result["total_students"], result1["total_students"])
        self.assertEqual(analyser.result["avg_score_top10"], result1["avg_score_top10"])
